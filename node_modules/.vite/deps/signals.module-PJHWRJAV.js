...
m("__r", function(i2, n2) {
  ...
  if (t3) {
    t3.__$f &= -2;
    if (void 0 === (r2 = t3.__$u)) t3.__$u = r2 = function(i3) {
      var n3;
      E(function() {
        n3 = this;
      });
...
var y3 = "undefined" == typeof requestAnimationFrame ? setTimeout : function(i2) {
  var n2 = function() {
    ...
    i2();
  }, r2 = setTimeout(n2, 100), t3 = requestAnimationFrame(n2);
};
var k = function(i2) {
...
function F() {
  if (1 === p2.push(this)) (l.requestAnimationFrame || k)(w2);
}
...
//# sourceMappingURL=signals.module-PJHWRJAV.js.map
